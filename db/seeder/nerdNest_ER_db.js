  ...
  const databaseTableStructure = [
    ...
    "CREATE TABLE IF NOT EXISTS products (product_id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255), brand VARCHAR(255), description TEXT, specs TEXT, price DECIMAL, stock_quantity BIGINT, stock_sold BIGINT, image_url VARCHAR(255), category_id INT,created_at DATE NOT NULL);",
