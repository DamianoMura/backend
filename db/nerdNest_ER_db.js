...
//queries used to create the db:
  ...
  const createTables = () =>{
      ...
      "CREATE TABLE `users` (`user_id` int PRIMARY KEY AUTO_INCREMENT, `name` varchar(255), `surname` varchar(255), `address` varchar(255), `email` varchar(255) UNIQUE, `password` varchar(255));",
      "CREATE TABLE `categories` (`category_id` int PRIMARY KEY AUTO_INCREMENT, `name` varchar(255), `icon` varchar(255) );",
      "CREATE TABLE `products` (`product_id` int PRIMARY KEY AUTO_INCREMENT, `name` varchar(255), `description` text, `price` decimal, `stock_quantity` int, `specs` text, `image_url` varchar(255), `category_id` int);",
      ...
      "CREATE TABLE `carts` (`cart_id` int PRIMARY KEY AUTO_INCREMENT, `user_id` int);",
      "CREATE TABLE `cart_items` (`cart_item_id` int PRIMARY KEY AUTO_INCREMENT, `cart_id` int, `product_id` int, `quantity` int);",
      "CREATE TABLE `orders` (`order_id` int PRIMARY KEY AUTO_INCREMENT, `user_id` int, `discount_codes_id` int);",
      "CREATE TABLE `orders_items` (`orders_items_id` int PRIMARY KEY AUTO_INCREMENT, `product_id` int, `order_id` int, `quantity` int);",
    ...
    db_connection.connect(function(err) {
      ...
      console.log("(creating tables ) Connected!");
